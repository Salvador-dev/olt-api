...
class OltSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $oltData = [['name' => 'OLT-HUAWEI-UNICENTER', 'ip' => '172.29.0.2'], ['name' => 'OLT-HUAWEI-BARQUISIMETO-OESTE-I(PRADO)', 'ip' => '190.120.252.184'], ['OLT-HUAWEI-FLOR-AMARILLO', '190.120.253.215']];
